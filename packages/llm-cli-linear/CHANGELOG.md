...
- Print GraphQL query as plain text in --debug=pretty mode
- Add --reveal flag to op credential retrieval
- Use XDG config path instead of dirs crate for config resolution
...
- Add --mine, --team, --state filter flags to issues list
...
- Add --debug flag to linear and discourse crates
- Implement llm-cli-linear with issues list/get/create/close
